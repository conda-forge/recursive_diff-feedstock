...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/recursive_diff-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/recursive_diff-feedstock)
...
Once the `conda-forge` channel has been enabled, `recursive_diff` can be installed with:

```
conda install recursive_diff
```

It is possible to list all of the versions of `recursive_diff` available on your platform with:
